...
@pytest.mark.parametrize("username, em, password1, password2", [
    ("CustomerTest","21201201@uap-bd.edu", "abcdabcd", "abcdabcd"),
    ("CustomerTest", "wrong", "abcdabcd", "abcdabcd"),
    ("Customer Test", "21201201@uap-bd.edu", "abcdabcd", "abcdabcd"),
    ("Customer Test", "21201201@uap-bd.edu", "abcdabc", "abcdabcd"),
    ("Customer_Test", "21201201@uap-bd.edu", "wrong", "wrong"),
])
def test_login(driver, username,em, password1, password2):
    driver.get("http://127.0.0.1:8000/register/customer2")
